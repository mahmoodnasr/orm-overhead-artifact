...
class PartSupp(Base):
    ...
    partkey_id = Column(
        "ps_partkey", Integer, ForeignKey("part.p_partkey"), primary_key=True
    )
    suppkey_id = Column(
        "ps_suppkey", Integer, ForeignKey("supplier.s_suppkey"), primary_key=True
    )
...
class LineItem(Base):
    ...
    orderkey_id = Column(
        "l_orderkey", Integer, ForeignKey("orders.o_orderkey"), primary_key=True
    )
