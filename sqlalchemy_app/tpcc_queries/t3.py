...
def run_transaction_orm(session: Session):
    ...
    try:
        ...
        last_order = (
            session.query(Order)
            .filter_by(o_w_id=w_id, o_d_id=d_id, o_c_id=c_id)
        ...
        order_lines = (
            ...
            .filter_by(ol_w_id=w_id, ol_d_id=d_id, ol_o_id=last_order.o_id)
            .order_by(OrderLine.ol_number)
            .all()
        )
