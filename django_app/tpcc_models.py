...
class TpccCustomer(models.Model):
    ...
    c_credit_lim = models.DecimalField(max_digits=12, decimal_places=2, db_column='c_credit_lim')
    c_discount = models.DecimalField(max_digits=4, decimal_places=4, db_column='c_discount')
    c_balance = models.DecimalField(max_digits=12, decimal_places=2, db_column='c_balance')
    c_ytd_payment = models.DecimalField(max_digits=12, decimal_places=2, db_column='c_ytd_payment')
    ...
    class Meta:
        ...
        indexes = [
            ...
            models.Index(fields=['c_w_id', 'c_d_id', 'c_last'], name='idx_customer_wdl'),
        ]
...
class History(models.Model):
    ...
    class Meta:
        ...
        managed = False
        indexes = [
            models.Index(fields=['h_c_w_id', 'h_c_d_id', 'h_c_id'], name='idx_history_customer'),
        ]
...
class TpccOrder(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=['o_w_id', 'o_d_id', 'o_c_id'], name='idx_order_customer'),
        ]
...
class OrderLine(models.Model):
    ...
    ol_amount = models.DecimalField(max_digits=6, decimal_places=2, db_column='ol_amount')
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=['ol_w_id', 'ol_d_id', 'ol_o_id'], name='idx_orderline_order'),
        ]
