...
class Supplier(models.Model):
    ...
    acctbal = models.DecimalField(max_digits=15, decimal_places=2, db_column='s_acctbal')
...
class Part(models.Model):
    ...
    retailprice = models.DecimalField(max_digits=15, decimal_places=2, db_column='p_retailprice')
...
class PartSupp(models.Model):
    ...
    partkey = models.ForeignKey(
        Part,
        on_delete=models.DO_NOTHING,
        db_column='ps_partkey'
    )
    suppkey = models.ForeignKey(
        Supplier,
        on_delete=models.DO_NOTHING,
        db_column='ps_suppkey'
    )
    availqty = models.IntegerField(db_column='ps_availqty')
    supplycost = models.DecimalField(max_digits=15, decimal_places=2, db_column='ps_supplycost')
...
class Customer(models.Model):
    ...
    acctbal = models.DecimalField(max_digits=15, decimal_places=2, db_column='c_acctbal')
...
class Orders(models.Model):
    ...
    totalprice = models.DecimalField(max_digits=15, decimal_places=2, db_column='o_totalprice')
...
class LineItem(models.Model):
    ...
    quantity = models.DecimalField(max_digits=15, decimal_places=2, db_column='l_quantity')
    extendedprice = models.DecimalField(max_digits=15, decimal_places=2, db_column='l_extendedprice')
    discount = models.DecimalField(max_digits=15, decimal_places=2, db_column='l_discount')
