...
def run_query_orm(using='default', params=None):
    ...
    results = (
        ...
        .filter(
            Q(suppkey__nationkey__name=P['nation1'], orderkey__custkey__nationkey__name=P['nation2']) |
            Q(suppkey__nationkey__name=P['nation2'], orderkey__custkey__nationkey__name=P['nation1']),
