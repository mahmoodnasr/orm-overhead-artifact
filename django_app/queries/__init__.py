...
def get_query_info(query_number):
    ...
    return {'number': query_number, 'name': f'Query {query_number}', 'complexity': 'Unknown'}

__all__ = [
    'q01', 'q02', 'q03', 'q04', 'q05', 'q06', 'q07', 'q08', 'q09', 'q10',
    'q11', 'q12', 'q13', 'q14', 'q15', 'q16', 'q17', 'q18', 'q19', 'q20',
    'q21', 'q22',
    'QUERY_MODULES', 'get_query_module', 'get_all_queries', 
    'get_query_name', 'get_query_complexity', 'get_query_info'
]
...
def get_query_module_for_db(query_num, database='default'):
    ...
    if 'mssql' in engine.lower() or 'sqlserver' in engine.lower():
        ...
        try:
            return __import__(f'django_app.queries.{sqlserver_module}', fromlist=[sqlserver_module])
        except ImportError:
    ...
    if 'oracle' in engine.lower():
        ...
        try:
            return __import__(f'django_app.queries.{oracle_module}', fromlist=[oracle_module])
        except ImportError:
            pass  # Fall back to default
